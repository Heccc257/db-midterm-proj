...
curl --location --request PUT 'http://127.0.0.1:9999/complete_offer?uid=2&offer_id=4'
...
curl --location --request PUT 'http://127.0.0.1:9999/complete_offer?uid=1&offer_id=5'
